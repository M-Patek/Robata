...
class StreamPerceptionSession:
    ...
    def _accept_observation(
        ...
        *,
        ...
        self._qa_history.append(qa_projection)
        self._evidence_history.append(evidence_projection)

        def reconcile_context() -> TemporalReconcileResult:
            return self._pipeline._reconciler.reconcile(self._tracks, event_projection)
