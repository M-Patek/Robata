"""Run offline preflight checks for a local Robata mainline execution."""
...
from robata.runtime.preflight import run_preflight  # noqa: E402
...
def _parser() -> argparse.ArgumentParser:
    parser = _Parser(
        description=(
            "Check local Python, dependencies, mapping, source, and output readiness "
