...
def test_registry_checks_unique_2020_12_documents(registry: SchemaRegistry) -> None:
    assert registry.schema_names == (
        ...
        "persisted-barrier",
        "pre-eos-capture-subject",
        "primary-completion-record",
        "processing-run-node-membership",
        "provider-claim-payload",
        "raw-provider-response-artifact",
        "recording-finalization-map",
        "review-annotation",
        "review-reopen-command",
        "review-task",
        "selected-attempt-output",
        "selection-decision",
        "stream-accepted-call-evidence",
        "stream-inference",
        "stream-inference-attempt",
        "stream-inference-intent",
        "stream-inference-terminal",
        "stream-segment",
        "stream-window-result",
        "stream-work-message",
        "stream-work-plan",
